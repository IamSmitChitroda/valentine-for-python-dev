...
def txt():
	...
	pen.down()
	pen.color('#992600')
	pen.write("I am Yours, *******",font=("Courier",20,"italic"))
	time.sleep(2.5)
	pen.up() 
	pen.setpos(-600,-125) 
	pen.down()
	pen.color('deep pink') 
	pen.write("I love you, ******* \u2764\ufe0f ...", font=("Courier", 15, "italic"))
	time.sleep(2)
	pen.up() 
	pen.setpos(-600,-155) 
	pen.down() 
	...
	pen.down() 
	pen.color('deep pink') 
	pen.write("Thank You, *******,", font=("Courier", 15, "italic"))
	time.sleep(2)
	pen.up() 
	pen.setpos(-600,-305) 
	pen.down() 
	pen.color('red') 
	pen.write("I Love you, *******  \u2764\ufe0f... HAPPY VALENTINES DAY DEAR", font=("Courier", 15, "italic"))
